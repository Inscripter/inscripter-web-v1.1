...
This site is a work in progress. If you see dummy text on a page, it means I'm still working on it. You can follow updates on Twitter [@inscripter](https://twitter.com/inscripter).
...
For more information about how to use the plugin and the inscriptions it includes, [read the documentation](https://github.com/tailwindcss/typography/blob/master/README.md).
...
With `remark-gfm`, we get a few extra inscriptions in our markdown. Example: autolink literals.
