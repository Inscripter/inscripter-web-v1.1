...
export default async function IndexPage() {
  ...
  let totalMinted = 16421111123
  const value = totalMinted / totalSupply * 100;
...
<section className="space-y-6 pb-8 pt-6 md:pb-12 md:pt-10 lg:py-32">
  ...
  <Link
        ...
        {/* <p className="max-w-[42rem] leading-normal text-muted-foreground sm:text-xl sm:leading-8 top-24 absolute">
            please save my kuro
          </p> */}
          ...
          {/* <div className="container flex flex-col items-end w-full"> */}
      ...
      >
        ...
        <div className="mx-auto text-center md:max-w-[58rem]">
          <p className="leading-normal text-muted-foreground sm:text-lg sm:leading-7">
            Inscripter also includes a blog and a full-featured documentation site
      ...
      <section id="open-source" className="container py-8 md:py-12 lg:py-24">
        <div className="mx-auto flex max-w-[58rem] flex-col items-center justify-center gap-4 text-center">
          ...
          <p className="max-w-[85%] leading-normal text-muted-foreground sm:text-lg sm:leading-7">
            Inscripter is open source and powered by open source software. <br />{" "}
